...
export const getAdminAlbums = async (): Promise<Album[]> => {
    ...
    // Backend Admin Controller mengembalikan wrapper { data: [...] }
    return result.data; 
};
